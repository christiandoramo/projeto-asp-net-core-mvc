...
namespace WebApplicationMVC.Services
{
    ...
    {
        private WebApplicationMVCContext context;
        public SeedingService(WebApplicationMVCContext _context)
        {
            context = _context;
        }
        public void Seed()
        {
            ...
            {
                // para resolver o bug MySqlConnector.MySqlException: 'Unknown database 'bancoteste''
                // é necessario recriar o DB bancoteste para seedar os dados mysql
                // o seed nao cria o DB automaticamente apenas repopular
                // Update-Database pode recriar o DB, desde que o serviço no S.O. Mysql80 esteja ativado
                return;    // entrou aqui - Quer dizer que o DB java foi seedado antes
            }
            Department d1 = new Department(1, "Computadores");
            Department d2 = new Department(2, "Eletronicos");
            Department d3 = new Department(3, "Acessorios");
            Department d4 = new Department(4, "Livros");

            Seller s1 = new Seller(1, "Juninho", "juninho@gmail.com", new DateTime(1998, 1, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "Charlinha", "Charlinha.com", new DateTime(2005, 9, 13), 1000.0, d2);
            Seller s3 = new Seller(3, "Carlotinha", "Carlotinhail.com", new DateTime(1999, 12, 1), 1000.0, d2);
            Seller s4 = new Seller(4, "Tonito", "tonito@gmail.com", new DateTime(1995, 4, 2), 1000.0, d4);
            ...
            // adicionando ao db usando EntityFramework
